...
fn main() {
  ...
  bindgen::Builder::default()
    ...
    .whitelist_function("gpudevicemem_halo_pack_lo_packed3d1_f32")
    .whitelist_function("gpudevicemem_halo_pack_hi_packed3d1_f32")
    .whitelist_function("gpudevicemem_halo_unpack_lo_packed3d1_f32")
    .whitelist_function("gpudevicemem_halo_unpack_hi_packed3d1_f32")
    .whitelist_function("gpudevicemem_halo_ghost_pack_lo_packed3d1_f32")
    .whitelist_function("gpudevicemem_halo_ghost_pack_hi_packed3d1_f32")
    .whitelist_function("gpudevicemem_halo_edge_reduce_lo_packed3d1_f32")
    .whitelist_function("gpudevicemem_halo_edge_reduce_hi_packed3d1_f32")
