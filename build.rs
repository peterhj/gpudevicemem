...
fn main() {
  ...
  bindgen::Builder::default()
    ...
    .whitelist_function("gpudevicemem_halo_ring_3d1_unfill_f32")
    ...
    .whitelist_function("gpudevicemem_halo_ring_3d1_copy_lboundary_to_buf_f32")
    .whitelist_function("gpudevicemem_halo_ring_3d1_copy_rboundary_to_buf_f32")
    ...
    .whitelist_function("gpudevicemem_halo_ring_3d1_accumulate_buf_to_lboundary_f32")
    .whitelist_function("gpudevicemem_halo_ring_3d1_accumulate_buf_to_rboundary_f32")
    // "reduce.cu"
